...
function next(){
    ...
    spans[spanIndex].className = "on";
    let pic = document.getElementsByClassName("wrap")[0];
    let val = (-600)*spanIndex;
    pic.style.left = val+"px";
}
...
function lunbo(){
    next();
    Interval = setTimeout(lunbo,2000);
}
...
$(document).ready(function () {
    $("tr+tr td").click(function () {
        let td = $(this);
        let temp = td.text();
        let input = $("<input type='text' value='"+temp+"'/>");
